        ...
        <div className='px-6 md:p-0 grid md:grid-cols-8 gap-6 place-items-center'>
            ...
            <div className='flex flex-row p-6'>
               ...
               <div className='flex flex-col mt-4'>
                ...
                <p className='text-lg text-white/70 mt-2'>I am doing Btech degree in computer science and i am focusing on technologies.
            ...
            <div className='flex flex-row p-6'>
               ...
               <div className='flex flex-col mt-4'>
                ...
                <p className='text-lg text-white/70 mt-2'>  I approach challenges with a logical and systematic mindset.
            ...
            <div className='flex flex-row p-6'>
               ...
               <div className='flex flex-col mt-4'>
                ...
                <p className='text-lg text-white/70 mt-2'>As a Fullstack web Devloper,i specialize in ReactJS,NextJS,Tailwind CSS. 
